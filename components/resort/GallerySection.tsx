...
export function GallerySection({ resort }: GallerySectionProps) {
  ...
  return (
    <section id="gallery" className="bg-[#fbf8f1] px-5 py-16 sm:px-6 lg:py-24">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          ...
          <p className="max-w-sm text-sm leading-6 text-[#6b6a5f]">
        ...
        <div className="mt-10 grid auto-rows-[180px] gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {resort.gallery.map((imageUrl, index) => (
            <div
              key={imageUrl}
              className={`relative overflow-hidden rounded-md bg-[#e8ddc8] shadow-[0_24px_80px_rgba(52,43,31,0.08)] ${
                index === 0
