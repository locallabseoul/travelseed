import { dashboardMetrics, mockResort, quickActions, recentActivity, usageMetrics } from "@/components/dashboard/mockData";
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_0.42fr] lg:items-center">
          <div>
            <div className="flex flex-wrap gap-2">
              <Badge>{mockResort.status}</Badge>
              <Badge tone="sand">{mockResort.plan}</Badge>
            </div>
            <h1 className="mt-5 text-4xl font-semibold tracking-tight text-[#18352f]">Welcome back, {mockResort.name}</h1>
            ...
            <div className="mt-5 flex flex-wrap items-center gap-3 text-sm">
              <span className="rounded-full bg-[#f8f5ef] px-4 py-2 font-semibold text-[#18352f]">{mockResort.travelseedUrl}</span>
              <span className="text-[#6f7b74]">{mockResort.customDomain}</span>
            </div>
          ...
          <div className="rounded-2xl bg-[#18352f] p-5 text-white">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-white/60">{mockResort.type}</p>
            <h2 className="mt-3 text-2xl font-semibold">{mockResort.template}</h2>
            <p className="mt-3 text-sm leading-6 text-white/70">{mockResort.location}</p>
