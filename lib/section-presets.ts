...
export const sectionPresets: SectionPreset[] = [
  {
    ...
    card: {
      ...
      fallbackDescription: "Share what customers can expect, from menu highlights to signature local ingredients.",
    },
    settings: {
      title: "Food, drinks, and local flavor",
      intro: "Share menus, restaurant service, bar highlights, catering, or local food experiences customers can ask about directly.",
      items: ["Signature menu", "Local ingredients", "Private dining"],
      cards: [],
      ctaLabel: "Ask about dining",
      openingHours: "Breakfast daily from 7:00 AM to 10:30 AM",
      breakfastInfo: "Fresh breakfast, brunch, or daily menu options can be shared before customers visit or place an order.",
      privateDiningNote: "Private dining, catering, or special meal requests can be arranged directly on WhatsApp.",
    },
  },
  {
    id: "promotions",
    ...
    requiredPlan: "tree",
    isPublished: true,
    description: "Direct WhatsApp offers and seasonal packages.",
    layout: "promotions",
    editor: {
      titleLabel: "Promotion headline",
      introLabel: "Campaign introduction",
      itemsLabel: "Fallback promotion highlights",
      itemsHelp: "Add one WhatsApp offer, package, perk, or campaign message per line. Active package/highlight offers will appear first on the public page.",
      ctaLabel: "Promotion CTA label",
    },
    card: {
      eyebrow: "WhatsApp offer",
    ...
    settings: {
      title: "Direct WhatsApp offers",
      intro: "Highlight seasonal packages, limited promos, service bundles, and direct WhatsApp benefits.",
      items: ["Limited promo", "Direct WhatsApp perk", "Seasonal package"],
      cards: [],
      ctaLabel: "Ask for current offers",
      campaignNote: "Offers may vary by date, availability, and request details. Ask the business on WhatsApp for current terms.",
    },
  },
  {
    id: "spa-wellness",
    ...
    card: {
      eyebrow: "Wellness",
      fallbackDescription: "Describe the treatment, ritual, class, or facility customers can plan around.",
    },
    settings: {
      title: "Wellness for slower days",
      intro: "Introduce spa treatments, wellness rituals, yoga, recovery, and quiet services designed for customer wellbeing.",
  ...
  },
  {
    ...
    requiredPlan: "tree",
    isPublished: false,
    description: "Activities, tours, classes, and customer experiences.",
    layout: "activities",
    editor: {
      titleLabel: "Activities headline",
      introLabel: "Activities introduction",
      itemsLabel: "Activity highlights",
      itemsHelp: "Add one activity, tour, class, or customer experience per line.",
      ctaLabel: "Activities CTA label",
    },
    card: {
      eyebrow: "Customer experience",
      fallbackDescription: "Give customers a clear reason to ask about this activity or experience.",
    },
    settings: {
  ...
  },
  {
    ...
    card: {
      ...
      fallbackDescription: "Help customers understand why this nearby place is worth visiting.",
    },
    settings: {
      title: "Everything close enough",
      intro: "Help customers understand what is nearby, from beaches and cafes to landmarks, viewpoints, and local favorites.",
  ...
  },
  {
    ...
    card: {
      ...
      fallbackDescription: "Frame the event option around customer count, atmosphere, or inquiry intent.",
    },
    settings: {
      ...
      items: ["Wedding package", "Private dinner", "Retreat buyout"],
      cards: [],
